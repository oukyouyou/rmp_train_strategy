...
from resp_db.common_types import Number

def stationarity_tests(signal):
    try:
...
def calculate_respiratory_statistics(
    amplitudes: np.ndarray, sampling_rate: float = 26.0
    ...
    stationarity_tests_results = stationarity_tests(amplitudes)
